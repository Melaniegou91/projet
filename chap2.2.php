...
<html>
	...
	<div id="conteneur">
		...
		<div id="milieu">
			<img src="islande.jpg" width="100%"/>
				<div class="dialogue">
					...
					Quelle vue incroyable ! Va falloir que je le remercie de m'avoir envoyé ici. <br/>
					Bien, partons à la recherche de Gab. Tiens un numéro inconnu ? <br/>
					</p>
		...
		<div class="rep">
		<a  href="chap2.3.php"> Regarder votre téléphone </a>
		</div>
