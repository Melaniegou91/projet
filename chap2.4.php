...
<html>
	...
	<div id="conteneur">
		...
		<div id="milieu">
			<img src="islande.jpg" width="100%"/>
				<div class="dialogue">
					...
					QUOI ? Il m'a encore piégé ! Je ne vais pas faire demi-tour maintenant. <br/>
					Il croit que je ne suis pas capable de le retrouver, c'est ce qu'on va voir.
					</p>
		...
		<div class="rep">
		<a  href="chap2.5.php"> Continuer </a>
		</div>
