	...
	<div id="conteneur">
		...
		<div id="gauche"> 			
			...
			if ($_SESSION['civ']=='fille')
					{echo '<img src="fille.png" width="57%"> ';
					}
			else
		...
		<div id="milieu">
			<img src="riziere.jpg" width="100%"/>
				<div class="dialogue">
					...
					"Hello, que dirais-tu comme prochaine destination Sydney ?" <br/>
					T'es marrant Gabriel c'est pas comme si j'avais le choix.
		...
		<div class="rep">
		<a  href="chap4.1.php"> C'est parti pour le pays des kangourous </a>
		</div>
