	...
	<div id="conteneur">
		...
		<div id="gauche"> 			
			...
			if ($_SESSION['civ']=='fille')
					...
					{echo '<img src="index.png" width="49%"> ';
					}
			?>
		</div>
		
		<div id="milieu">
			<img src="salle.jpg" width="100%"/>
				<div class="dialogue">
					...
					<i>Tu as fait ton choix bien rapidement <?php echo $_SESSION['nom'];?> ! <br/>
					N'oublie pas de retenir les indices. A toi de jouer ;)
					</i></p>
		...
		<div class="rep">
		<a  href="chap2.1.php">Continuer</a>
		</div>
