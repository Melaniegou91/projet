	...
	<div id="conteneur">
		...
		<div id="gauche"> 			
			...
			if ($_SESSION['civ']=='fille')
					{echo '<img src="fille2.png" width="71%"> ';
					}
			else
		...
		<div id="milieu">
			<img src="rift.jpg" width="100%"/>
				<div class="dialogue">
					...
					Je dois déjà quitter l'Islande, ça va me manquer... <br/>
					Mais bon je dois me dépêcher si je veux réussir à l'attraper !
					</p>
		...
		<div class="rep">
		<a  href="chap3.1.php"> Partir au Vietnam </a>
		</div>
