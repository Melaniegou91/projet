...
<html>
	...
	<div id="conteneur">
		...
		<div id="milieu">
			<img src="lettre.jpg" width="100%"/>
				<div class="dialogue">
					...
					"Salut <?php echo $_SESSION['nom'];?>, j'espère que tu ne m'as pas déjà oublié ! <br/>
					J'ai besoin de ton aide, retrouve moi là-bas. <b>27°N</b><br/> Signé ton meilleur ami."
		...
		<div class="rep">
		<a  href="chap1.2.php"> Continuer </a>
		</div>
